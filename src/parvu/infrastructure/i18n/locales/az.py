...
TRANSLATIONS_AZ = {
    ...
    "export.progress": "{path} faylına ixrac edilir…",
    "export.progress_rows": "{total} sətirdən {rows} ixrac edildi…",
    "export.cancelled": "İxrac ləğv edildi.",
